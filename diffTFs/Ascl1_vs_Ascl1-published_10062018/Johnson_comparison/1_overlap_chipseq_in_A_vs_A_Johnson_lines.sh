...
cd /gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/diffTFs/Ascl1_vs_Ascl1-published_10062018/Johnson_comparison
...
multi_out="/gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/multigps_calls/Ascl1_comparison_28092018/Ascl1_comparison_28092018_multigps"

# Condition name for the datasets as used in the design file
condition_name_A="EB+48hr_iA_Ascl1"
condition_name_N="Johnson_Ascl1_24hrES"
...
readdb_N="Johnson Dox-24hESCs[Ascl1] Ascl1 ESCs;bowtie_unique"
# Color code like "0 125 0 255"
color="133 193 233 255" 
# seq-code jar file
...
echo "\"$readdb_A\""
### 
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 5 --linemax 181 --linethick 1 --readext 100 --color4 $color --rdbexpt "$readdb_A"  --peaks $I --out ${I/.ordered/_iA}; done
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 5 --linemax 24 --linethick 1 --readext 100 --color4 $color --rdbexpt "$readdb_N"  --peaks $I --out ${I/.ordered/_iN}; done
