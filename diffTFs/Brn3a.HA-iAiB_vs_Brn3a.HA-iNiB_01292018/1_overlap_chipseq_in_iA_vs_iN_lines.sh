...
cd /gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/diffTFs/Brn3a.HA-iAiB_vs_Brn3a.HA-iNiB_01292018
...
multi_out="/gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/multigps_calls/Brn3a.HA_16112017/Brn3a.HA_16112017_multigps"

# Condition name for the datasets as used in the design file
condition_name_A="Brn3a.HA_iAscl1.iBrn3a_24hr"
condition_name_N="Brn3a.HA_iNgn2.iBrn3a_24hr"
# Name of the factor
fac="Brn3a.HA"
...
echo "\"$readdb_A\""
### 
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 10 --linemax 139 --linethick 1 --readext 100 --color4 $color --rdbexpt "$readdb_A"  --peaks $I --out ${I/.ordered/_iA}; done
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 10 --linemax 105 --linethick 1 --readext 100 --color4 $color --rdbexpt "$readdb_N"  --peaks $I --out ${I/.ordered/_iN}; done
