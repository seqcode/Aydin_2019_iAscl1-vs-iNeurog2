...
b=/gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/diffTFs/iBrn2_vs_iA_iN_11132018/Brn2_ia_gt_in.peaks
a1=$(basename $a);
b1=$(basename $b);
x=${a1/.peaks/};
y=${b1/.peaks/};
...
b=/gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/diffTFs/iBrn2_vs_iA_iN_11132018/Brn2_in_gt_ia.peaks
a1=$(basename $a);
b1=$(basename $b);
x=${a1/.peaks/};
y=${b1/.peaks/};
