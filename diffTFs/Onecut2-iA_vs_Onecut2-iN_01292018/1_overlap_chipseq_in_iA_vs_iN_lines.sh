...
cd /gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/diffTFs/Onecut2-iA_vs_Onecut2-iN_01292018
...
multi_out="/gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/multigps_calls/Onecut2_26012018/Onecut2_26012018_multigps"

# Condition name for the datasets as used in the design file
condition_name_A="Onecut2_iAscl1_48hr"
condition_name_N="Onecut2_iNgn2_48hr"
# Name of the factor
fac="Onecut2"
...
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 5 --linemax 128 --linethick 1 --readext 100 --color4 $color --rdbexpt "$readdb_N"  --peaks $I --out ${I/.ordered/_iN}; done
