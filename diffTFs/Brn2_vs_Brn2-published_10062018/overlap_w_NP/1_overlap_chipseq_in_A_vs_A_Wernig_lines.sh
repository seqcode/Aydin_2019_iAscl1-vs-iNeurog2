...
cd /gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/diffTFs/Brn2_vs_Brn2-published_10062018/overlap_w_NP
...
multi_out="/gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/multigps_calls/Brn2_comparison_28092018/Brn2_comparison_28092018_multigps"

# Condition name for the datasets as used in the design file
condition_name_A="Brn2_iAscl1_48hr"
condition_name_N="Wernig_Brn2_NP"
...
readdb_N="Wernig NP Brn2 C57BL6;1;bowtie_unique"
# Color code like "0 125 0 255"
color="241 124 21 255" 
# seq-code jar file
...
echo "\"$readdb_A\""
### 
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 5 --linemax 197 --linethick 1 --readext 100 --color4 $color --rdbexpt "$readdb_A"  --peaks $I --out ${I/.ordered/_iA}; done
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 5 --linemax 51 --linethick 1 --readext 100 --color4 $color --rdbexpt "$readdb_N"  --peaks $I --out ${I/.ordered/_iN}; done
