...
cd /gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/diffTFs/Brn2-iA_vs_Brn2-iN_01292018
...
multi_out="/gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/multigps_calls/Brn2_14112017/Brn2_14112017_multigps"
...
readdb_Oc2_A="Mazzoni EB+48hrDox(iAscl1.V5) Onecut2 Ainv15(iAscl1.V5);bowtie_unique"
readdb_Oc2_N="Mazzoni EB+48hrDox(iFlag.Ngn2) Onecut2 Ainv15(iFlag.Ngn2);bowtie_unique"
...
echo "\"$readdb_A\""
### 
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 10 --linemax 99 --linethick 1 --readext 100 --color4 $color --rdbexpt $readdb_A  --peaks $I --out ${I/.ordered/_iA}; done
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 10 --linemax 67 --linethick 1 --readext 100 --color4 $color --rdbexpt $readdb_N  --peaks $I --out ${I/.ordered/_iN}; done
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 10 --linemax 76 --linethick 1 --readext 100 --color4 $color --rdbexpt $readdb_Oc2_A  --peaks $I --out ${I/.ordered/_Oc2_A}; done
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 10 --linemax 128 --linethick 1 --readext 100 --color4 $color --rdbexpt $readdb_Oc2_N  --peaks $I --out ${I/.ordered/_Oc2_N}; done
