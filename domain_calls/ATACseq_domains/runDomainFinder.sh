...
java -Xmx60G org.seqcode.projects.seed.DomainFinder --threads 4 --species "Mus musculus;mm10" --seq ~/group/genomes/mm10/ --design ascl1.design --peakfinding max --binwidth 50 --binstep 25 --poisslogpthres -5 --binpthres 0.05 --out ascl1_domains > ascl1.log 2>&1
