...
cd /gpfs/group/sam77/default/projects/es/iAscl1_iNgn2/diffTFs/Ascl1_vs_Ascl1-published_10062018
...
condition_name_N="Wernig_Ascl1_+d2_iBAM"
...
echo "\"$readdb_A\""
### 
for I in *ordered; do java -Xmx50G -Djava.awt.headless=true -cp $seqcodejar  org.seqcode.viz.metaprofile.MetaMaker --species "Mus musculus;mm10"  --win 1000 --bins 500 --profiler simplechipseq --batch --nocolorbar --linemin 5 --linemax 94 --linethick 1 --readext 100 --color4 $color --rdbexpt "$readdb_A"  --peaks $I --out ${I/.ordered/_iA}; done
